package com.mycom.action.controller;
...
import com.mycom.action.service.StoreService;
...
/////////////////////////////////////////////	
	...
	public ModelAndView storeDelete(StoreVO storeVO, HttpServletRequest request) throws Exception {
		...
		mv.addObject("path", "store/storeList");
...
/////////////////////////////////////////////
	...
	public ModelAndView storeWrite(StoreVO storeVO, MultipartFile file, HttpServletRequest request) throws Exception {
	...
	public String storeWrite(HttpServletRequest request) throws Exception {
