...
public class DTO {
	...
	private String movie_sort, movie_title, movie_director, movie_actor, movie_age_grade;
	private String movie_runningtime, movie_country, movie_content, movie_status;
	private String movie_open_date,movie_close_date;
	private String movie_admin_id;
	public DTO() {
		super();
	}
