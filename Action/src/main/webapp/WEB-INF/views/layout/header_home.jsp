...
<div id="header">
	<div id="head">
		...
		<div id="h12">
		<div id="h2">
		<c:if test="${sessionScope.AUTHUSER_ID eq null}">
		...
		<c:if test="${sessionScope.AUTHUSER_ID ne null }">
		    <div class="himg hname">${sessionScope.AUTHUSER_ID}님</div>
			<div class="himg"><a href="./member/memberLogout"><img alt="" src="./resources/images/home/7_2.png"></a></div>
		
		<c:if test="${sessionScope.AUTHUSER_ID.grade eq 6}">
		<div class="himg"><a href="./admin/adminmain"><img alt="" src="./resources/images/home/8_2.png"></a></div>	
		</c:if>
		
		<c:if test="${sessionScope.AUTHUSER_ID.grade ne 6}">
